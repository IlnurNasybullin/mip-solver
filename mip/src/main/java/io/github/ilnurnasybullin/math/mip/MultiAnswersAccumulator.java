...
class MultiAnswersAccumulator implements AnswersAccumulator<List<SimplexAnswer>> {
    ...
    MultiAnswersAccumulator(FunctionType functionType) {
    ...
    public List<SimplexAnswer> answer() {
        return answers;
    }
